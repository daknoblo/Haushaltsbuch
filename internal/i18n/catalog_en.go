...
var english = Catalog{
	...
	"bookings.whoPaysHint":     "Only the people ticked carry a share: both ticked means half each, one alone carries it in full.",
	...
	"dash.transferHint":      "%s carries shares that %s fronted, minus whatever they fronted themselves.",
	"dash.transferNetted":    "Netted across the household, so the payment differs from this total.",
	"dash.transferPayerHint": "The chip names who fronts the bill.",
	"dash.sum":               "Total",
	...
	"dash.sharedTotal":       "Split",
	"dash.soleTotal":         "Carried alone",
