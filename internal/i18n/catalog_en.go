...
var english = Catalog{
	...
	"bookings.settleAutoHint":      "Automatically off: the payer carries the full cost alone. Changing the allocation restores your previous setting.",
	...
	"bookings.left":                "Left",
	"bookings.search":              "Full-text booking search (at least 2 characters)",
	...
	"matrix.hint":           "Every category across the months. Click a category to see its bookings. Surplus is calculated only for months with recorded income.",
	"matrix.row":            "Item",
	"matrix.total":          "Total",
	"matrix.mean":           "Mean",
	"matrix.trendUp":        "more than the month before",
	"matrix.trendDown":      "less than the month before",
	"matrix.trendFlat":      "unchanged from the month before",
	...
	"settings.statBookings":         "Bookings",
	"settings.statRhythm":           "%d recurring, %d one-off",
	"settings.statUnused":           "%d unused",
	"settings.statSplits":           "%d shares assigned",
	"settings.statOverrides":        "%d bookings carry overriding amounts",
	"settings.statSpan":             "Planned period: %s to %s",
	"settings.statChanged":          "Last changed: %s",
