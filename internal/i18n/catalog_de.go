...
var german = Catalog{
	...
	"bookings.whoPaysHint":     "Nur angehakte Personen tragen mit: beide angehakt = jeder die Hälfte, nur eine = sie trägt allein.",
	...
	"dash.transferHint":      "%s trägt Anteile, die %s vorgestreckt hat; selbst vorgestreckte Anteile werden abgezogen.",
	"dash.transferNetted":    "Über den Haushalt verrechnet, deshalb weicht die Zahlung von dieser Summe ab.",
	"dash.transferPayerHint": "Die Marke nennt, wer die Rechnung vorstreckt.",
	"dash.sum":               "Summe",
	...
	"dash.sharedTotal":       "Geteilt",
	"dash.soleTotal":         "Allein getragen",
