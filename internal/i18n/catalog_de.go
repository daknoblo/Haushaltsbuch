...
var german = Catalog{
	...
	"bookings.settleAutoHint":      "Automatisch aus: Zahler und alleiniger Kostenträger sind dieselbe Person. Bei geänderter Aufteilung gilt wieder deine vorherige Einstellung.",
	...
	"bookings.left":                "Übrig",
	"bookings.search":              "Buchungen durchsuchen (ab 2 Zeichen)",
	"bookings.searchPlaceholder":   "Buchungen durchsuchen",
	...
	"matrix.hint":          "Jede Kategorie über die Monate. Ein Klick auf eine Kategorie zeigt ihre Buchungen. Überschüsse werden nur für Monate mit erfassten Einnahmen berechnet.",
	"matrix.row":           "Posten",
	"matrix.total":         "Gesamt",
	"matrix.mean":          "Mittelwert", "matrix.trendUp": "mehr als im Vormonat",
	"matrix.trendDown": "weniger als im Vormonat",
	"matrix.trendFlat": "unverändert zum Vormonat", "matrix.median": "Median",
	...
	"settings.statBookings":         "Buchungen",
	"settings.statRhythm":           "%d wiederkehrend, %d einmalig",
	"settings.statUnused":           "%d ungenutzt",
	"settings.statSplits":           "%d Anteile vergeben",
	"settings.statOverrides":        "%d Buchungen haben abweichende Beträge hinterlegt",
	"settings.statSpan":             "Geplanter Zeitraum: %s bis %s",
	"settings.statChanged":          "Zuletzt geändert: %s",
